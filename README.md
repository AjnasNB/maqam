...
> **Release status is live-record-driven:** verify the current version with `npm view maqam dist-tags.latest gitHead dist.integrity` and the repository's [latest release page](https://github.com/AjnasNB/maqam/releases/latest). [`maqam@0.3.0`](https://www.npmjs.com/package/maqam/v/0.3.0) is a verified historical release published through npm Trusted Publishing and paired with [`v0.3.0`](https://github.com/AjnasNB/maqam/releases/tag/v0.3.0); a packaged README cannot predict a later dist-tag or release.
