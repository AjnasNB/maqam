...
Use this root checklist as the release gate for `maqam@0.2.1`.
...
Do not publish from automation. Stop after preparing evidence and request explicit user approval for `maqam@0.2.1`.
